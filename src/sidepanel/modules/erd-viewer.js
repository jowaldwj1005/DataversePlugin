...
export default class ErdViewer {
  ...
  async _exportSchema() {
    ...
    // JSON Schema draft-07 — one definitions entry per entity, root $ref list
    const schema = {
  ...
  async _exportPayload() {
    ...
    // Include required fields as concrete values + optional writable fields as comments-in-value
    const payload = {};
